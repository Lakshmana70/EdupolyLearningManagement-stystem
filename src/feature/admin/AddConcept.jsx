                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h1 class="modal-title fs-5" id="exampleModalLabel">Concept Name</h1>
                    ...
                    <div class="modal-footer">
                      ...
                      {
                      flag.status===true ?<button type="button" class="btn btn-primary" data-bs-dismiss="modal" onClick={() => { editConcept() }}>Update changes</button>
                       : <button type="button" class="btn btn-primary" data-bs-dismiss="modal" onClick={() => { addConcept() }}>Add Concept</button>
